        ...
        <Reveal>
          <div className="section-header" style={{ marginBottom: 24 }}>
            <AppWindow skin={APP_SKINS.console}>
              ...
              <h2 className="section-header-title" style={SECTION_TITLE_STYLE}>Один человек отвечает за весь результат.</h2>
            </AppWindow>
          </div>
        </Reveal>
        <Reveal delay={80}>
