...
const MISSION_HEADLINE = [["Делаю", "сайты,", "которые"], ["помогают", "бизнесу", "расти."]];
const MISSION_LINES = [
  { words: ["Не", "сдаю", "макет"], pad: "0" },
  { words: ["и", "не", "пропадаю", "после", "оплаты."], pad: "clamp(28px,5vw,80px)" },
  { words: ["Ищу,", "что", "доработать,"], pad: "clamp(14px,2.5vw,40px)" },
  { words: ["чтобы", "сайт", "продавал", "лучше."], pad: "clamp(42px,7vw,110px)" },
];
