        ...
        <Reveal>
          <div className="section-header" style={{ marginBottom: 24 }}>
            <AppWindow skin={APP_SKINS.claude}>
              ...
              <h2 className="section-header-title" style={{ ...mono, fontWeight: 700, fontSize: "clamp(18px,4vh,36px)", color: "#00ff41", lineHeight: 1.05, marginTop: 14 }}>
        ...
        <Reveal>
          <div className="section-header" style={{ marginBottom: 24 }}>
            <AppWindow skin={APP_SKINS.console}>
              ...
              <h2 className="section-header-title" style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 700, fontSize: "clamp(20px,4.4vh,40px)", color: "#f2f2f2", marginTop: 14 }}>Один человек отвечает за весь результат.</h2>
            </AppWindow>
          </div>
        </Reveal>
        <Reveal delay={80}>
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        <Reveal>
          <div className="section-header" style={{ borderTop: "1px solid rgba(0,255,65,.18)", paddingTop: 20, marginBottom: 24 }}>
            ...
            <h2 className="section-header-title" style={{ fontFamily: "'Montserrat',sans-serif", fontWeight: 700, fontSize: "clamp(20px,4.4vh,40px)", color: "#f2f2f2", marginTop: 14 }}>Четыре шага. Вы видите результат на каждом.</h2>
          </div>
        </Reveal>
        <Reveal delay={80}>
...
function Contact(){return <section id="contact" style={{flexShrink:0,scrollSnapAlign:"start",width:"max(1100px,100vw)",height:"100vh",display:"flex",flexDirection:"column",justifyContent:"center",padding:"84px clamp(20px,4vw,60px) 20px",background:"#050f05",borderLeft:"1px solid rgba(0,255,65,.18)",position:"relative",overflow:"hidden"}}><SectionRain/><div className="contact-grid" style={{position:"relative",zIndex:1,display:"grid",gridTemplateColumns:"1.1fr .9fr",gap:44,alignItems:"center"}}><div><span style={{fontFamily:"'JetBrains Mono',monospace",fontSize:11,color:"#008f11"}}>04 / Связаться</span><h2 style={{fontFamily:"'JetBrains Mono',monospace",fontWeight:700,fontSize:"clamp(22px,6vh,48px)",color:"#00ff41",marginTop:14}}>Расскажите,<br/>что нужно<br/>сделать.</h2></div><TerminalBox title="~/contact/form.sh" accent><TerminalContactForm/></TerminalBox></div><MobileScrollHint sectionId="contact"/></section>;}
