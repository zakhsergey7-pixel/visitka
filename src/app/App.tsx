      ...
      <div ref={ref} style={{ position: "relative", zIndex: 1 }}>
        ...
        <Reveal delay={100}>
          <div style={{ border: "1px solid rgba(0,255,65,.2)", animation: "borderGlow 4s ease-in-out infinite" }}>
            ...
            <div className="ai-table-head" style={{ display: "grid", gridTemplateColumns: "44px 1fr 300px", gap: "0 clamp(12px,2vw,28px)", padding: "8px 16px 6px", borderBottom: "1px solid rgba(0,255,65,.1)", ...mono, fontSize: 10, letterSpacing: ".14em", textTransform: "uppercase", color: "rgba(0,255,65,.35)" }}>
